...
* The following dependencies are not known to work with Spring Native: 'Spring Web Services, Spring Configuration Processor,
  Spring Boot DevTools, Rest Repositories'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 BookMyShow:0.0.1-SNAPSHOT
```

### Executable with Native Build Tools

Use this option if you want to explore more options such as running your tests in a native image. The GraalVM native-image
